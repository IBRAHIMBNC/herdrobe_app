...
class AuthService extends GetxService {
  ...
  Future<bool> createUserWithEmailAndPassword({
    ...
    try {
      ...
      print(e.code);
      final exception = FirebaseAuthError.fromCode(e.code);
      authError = exception;
      errorLog.e(exception?.msg ?? e.toString());
    } catch (e) {
      print(e.runtimeType);
      errorLog.e('$e');
      return false;
  ...
  Future<bool> deleteAccount(String password) async {
    ...
    if (currentUser != null) {
      ...
      try {
        ...
        errorLog.e('Reauthentication failed: $err');
        return false;
      }
  ...
  Future<bool> changePassword(
    ...
    try {
      ...
      final exception = FirebaseAuthError.fromCode(error.code);
      authError = exception;
      errorLog.e(exception?.msg ?? error.toString());
    }
